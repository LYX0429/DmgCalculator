const MOVES = [
  // ── 通用愿力技能（universal: true，所有精灵技能栏可见）────────────────────
  { id: "物愿力冲击（普通）", name: "物愿力冲击（普通）", power: 80, cost: 3, category: "physical", type: "普通",  icon: "assets/icons/type-putong.png", note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（普通）", name: "魔愿力冲击（普通）", power: 80, cost: 3, category: "special",  type: "普通",  icon: "assets/icons/type-putong.png", note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（光）",   name: "物愿力冲击（光）",   power: 80, cost: 3, category: "physical", type: "光",    icon: "assets/icons/type-guang.png",  note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（光）",   name: "魔愿力冲击（光）",   power: 80, cost: 3, category: "special",  type: "光",    icon: "assets/icons/type-guang.png",  note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（火）",   name: "物愿力冲击（火）",   power: 80, cost: 3, category: "physical", type: "火",    icon: "assets/icons/type-huo.png",    note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（火）",   name: "魔愿力冲击（火）",   power: 80, cost: 3, category: "special",  type: "火",    icon: "assets/icons/type-huo.png",    note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（水）",   name: "物愿力冲击（水）",   power: 80, cost: 3, category: "physical", type: "水",    icon: "assets/icons/type-shui.png",   note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（水）",   name: "魔愿力冲击（水）",   power: 80, cost: 3, category: "special",  type: "水",    icon: "assets/icons/type-shui.png",   note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（草）",   name: "物愿力冲击（草）",   power: 80, cost: 3, category: "physical", type: "草",    icon: "assets/icons/type-cao.png",    note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（草）",   name: "魔愿力冲击（草）",   power: 80, cost: 3, category: "special",  type: "草",    icon: "assets/icons/type-cao.png",    note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（电）",   name: "物愿力冲击（电）",   power: 80, cost: 3, category: "physical", type: "电",    icon: "assets/icons/type-dian.png",   note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（电）",   name: "魔愿力冲击（电）",   power: 80, cost: 3, category: "special",  type: "电",    icon: "assets/icons/type-dian.png",   note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（冰）",   name: "物愿力冲击（冰）",   power: 80, cost: 3, category: "physical", type: "冰",    icon: "assets/icons/type-bing.png",   note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（冰）",   name: "魔愿力冲击（冰）",   power: 80, cost: 3, category: "special",  type: "冰",    icon: "assets/icons/type-bing.png",   note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（地）",   name: "物愿力冲击（地）",   power: 80, cost: 3, category: "physical", type: "地",    icon: "assets/icons/type-di.png",     note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（地）",   name: "魔愿力冲击（地）",   power: 80, cost: 3, category: "special",  type: "地",    icon: "assets/icons/type-di.png",     note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（幻）",   name: "物愿力冲击（幻）",   power: 80, cost: 3, category: "physical", type: "幻",    icon: "assets/icons/type-huan.png",   note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（幻）",   name: "魔愿力冲击（幻）",   power: 80, cost: 3, category: "special",  type: "幻",    icon: "assets/icons/type-huan.png",   note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（龙）",   name: "物愿力冲击（龙）",   power: 80, cost: 3, category: "physical", type: "龙",    icon: "assets/icons/type-long.png",   note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（龙）",   name: "魔愿力冲击（龙）",   power: 80, cost: 3, category: "special",  type: "龙",    icon: "assets/icons/type-long.png",   note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（恶）",   name: "物愿力冲击（恶）",   power: 80, cost: 3, category: "physical", type: "恶",    icon: "assets/icons/type-e.png",      note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（恶）",   name: "魔愿力冲击（恶）",   power: 80, cost: 3, category: "special",  type: "恶",    icon: "assets/icons/type-e.png",      note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（武）",   name: "物愿力冲击（武）",   power: 80, cost: 3, category: "physical", type: "武",    icon: "assets/icons/type-wu.png",     note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（武）",   name: "魔愿力冲击（武）",   power: 80, cost: 3, category: "special",  type: "武",    icon: "assets/icons/type-wu.png",     note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（翼）",   name: "物愿力冲击（翼）",   power: 80, cost: 3, category: "physical", type: "翼",    icon: "assets/icons/type-yi.png",     note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（翼）",   name: "魔愿力冲击（翼）",   power: 80, cost: 3, category: "special",  type: "翼",    icon: "assets/icons/type-yi.png",     note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（萌）",   name: "物愿力冲击（萌）",   power: 80, cost: 3, category: "physical", type: "萌",    icon: "assets/icons/type-meng.png",   note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（萌）",   name: "魔愿力冲击（萌）",   power: 80, cost: 3, category: "special",  type: "萌",    icon: "assets/icons/type-meng.png",   note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（幽）",   name: "物愿力冲击（幽）",   power: 80, cost: 3, category: "physical", type: "幽",    icon: "assets/icons/type-you.png",    note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（幽）",   name: "魔愿力冲击（幽）",   power: 80, cost: 3, category: "special",  type: "幽",    icon: "assets/icons/type-you.png",    note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（虫）",   name: "物愿力冲击（虫）",   power: 80, cost: 3, category: "physical", type: "虫",    icon: "assets/icons/type-chong.png",  note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（虫）",   name: "魔愿力冲击（虫）",   power: 80, cost: 3, category: "special",  type: "虫",    icon: "assets/icons/type-chong.png",  note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（机械）", name: "物愿力冲击（机械）", power: 80, cost: 3, category: "physical", type: "机械",  icon: "assets/icons/type-jixie.png",  note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（机械）", name: "魔愿力冲击（机械）", power: 80, cost: 3, category: "special",  type: "机械",  icon: "assets/icons/type-jixie.png",  note: "应对攻击：威力+80", universal: true },
  { id: "物愿力冲击（毒）",   name: "物愿力冲击（毒）",   power: 80, cost: 3, category: "physical", type: "毒",    icon: "assets/icons/type-du.png",     note: "应对攻击：威力+80", universal: true },
  { id: "魔愿力冲击（毒）",   name: "魔愿力冲击（毒）",   power: 80, cost: 3, category: "special",  type: "毒",    icon: "assets/icons/type-du.png",     note: "应对攻击：威力+80", universal: true },
  ...
  { id: "魔法增效",   name: "魔法增效",   power: 0, cost: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/魔法增效.png", note: "自己获得魔攻+70%", selfBuffStacks: { "魔攻增强": 7 } },
  { id: "力量增效",   name: "力量增效",   power: 0, cost: 1,   category: "status",   type: "普通", icon: "assets/icons/moves/力量增效.png", note: "自己获得物攻+100%", selfBuffStacks: { "物攻增强": 10 } },
  ...
  { id: "防反",       name: "防反",       power: 0, cost: 2,   category: "defense",  type: "普通", icon: "assets/icons/moves/防反.png",   note: "减伤70%，应对攻击：自己获得物攻和魔攻+70%", selfBuffStacks: { "物攻增强": 7, "魔攻增强": 7 } },
  ...
  { id: "消毒法",     name: "消毒法",     power: 115, cost: 4, category: "special",  type: "普通", icon: "assets/icons/moves/消毒法.png", note: "驱散敌方5层增益" },
  ...
  { id: "嗜痛",       name: "嗜痛",       power: 0, cost: 2,   category: "defense",  type: "普通", icon: "assets/icons/moves/嗜痛.png",   note: "减伤80%，应对攻击：期间自己每次受到伤害获得双攻+40%", selfBuffStacks: { "物攻增强": 4, "魔攻增强": 4 } },
  ...
  { id: "伺机而动",   name: "伺机而动",   power: 0, cost: 1,   category: "status",   type: "普通", icon: "assets/icons/moves/伺机而动.png", note: "下一次攻击时，技能威力+70", selfBuffStacks: { "威力增强": 7 } },
  { id: "后发制人",   name: "后发制人",   power: 155, cost: 3, category: "physical", type: "普通", icon: "assets/icons/moves/后发制人.png", note: "先手-1" },
  { id: "三连破",     name: "三连破",     power: 0, cost: 1,   category: "status",   type: "普通", icon: "assets/icons/moves/三连破.png",  note: "自己获得物攻+30%，3连击", selfBuffStacks: { "物攻增强": 3 } },
  { id: "乘胜追击",   name: "乘胜追击",   power: 40, cost: 2,  category: "physical", type: "普通", icon: "assets/icons/moves/乘胜追击.png", note: "每次使用后，连击数永久+1" },
  { id: "快速移动",   name: "快速移动",   power: 0, cost: 1,   category: "status",   type: "普通", icon: "assets/icons/moves/快速移动.png", note: "自己获得速度+80，应对防御：改为速度+160", selfBuffStacks: { "速度增强": 8 } },
  ...
  { id: "阻断",       name: "阻断",       power: 75, cost: 2,  category: "special",  type: "普通", icon: "assets/icons/moves/阻断.png",   note: "应对状态：额外打断被应对技能" },
  { id: "加固",       name: "加固",       power: 0, cost: 2,   category: "status",   type: "普通", icon: "assets/icons/moves/加固.png",   note: "自己获得物防+140%", selfBuffStacks: { "物防增强": 14 } },
  ...
  { id: "鼓劲",       name: "鼓劲",       power: 0, cost: 3,   category: "status",   type: "普通", icon: "assets/icons/moves/鼓劲.png",   note: "自己获得魔防+170%", selfBuffStacks: { "魔防增强": 17 } },
  { id: "咆哮",       name: "咆哮",       power: 0, cost: 1,   category: "status",   type: "普通", icon: "assets/icons/moves/咆哮.png",   note: "敌方获得物攻-60%，速度-60" },
  ...
  { id: "聒噪",       name: "聒噪",       power: 0, cost: 3,   category: "status",   type: "普通", icon: "assets/icons/moves/聒噪.png",   note: "敌方获得全攻击技能能耗+2，持续3回合" },
  ...
  { id: "触底强击",   name: "触底强击",   power: 95, cost: 4,  category: "special",  type: "普通", icon: "assets/icons/moves/触底强击.png", note: "使用后若能量耗尽，本次技能威力+120" },
  ...
  { id: "抓挠",       name: "抓挠",       power: 35, cost: 0,  category: "physical", type: "普通", icon: "assets/icons/moves/抓挠.png",   note: "自己回复1能量" },
  { id: "重击",       name: "重击",       power: 110, cost: 2, category: "physical", type: "普通", icon: "assets/icons/moves/重击.png",   note: "每次使用后，本技能能耗永久+1" },
  { id: "吨位压制",   name: "吨位压制",   power: 0, cost: 3,   category: "physical", type: "普通", icon: "assets/icons/moves/吨位压制.png", note: "敌方体重越低，威力越高" },
  { id: "音波弹",     name: "音波弹",     power: 60, cost: 1,  category: "special",  type: "普通", icon: "assets/icons/moves/音波弹.png",  note: "1连击" },
  ...
  { id: "折射",       name: "折射",       power: 50, cost: 4,  category: "special",  type: "光",   icon: "assets/icons/moves/折射.png",   note: "携带电系技能：速度+20；携带机械系技能：物防+30%；携带光系技能：魔攻+30%；携带武系技能：物攻+30%；携带普系技能：技能威力+10" },
  ...
  { id: "怒火",       name: "怒火",       power: 0, cost: 1,   category: "status",   type: "火",   icon: "assets/icons/moves/怒火.png",   note: "自己获得双攻+120%和双防-40%", selfBuffStacks: { "物攻增强": 12, "魔攻增强": 12, "物防增强": -4, "魔防增强": -4 } },
  ...
  { id: "润泽",       name: "润泽",       power: 0, cost: 7,   category: "status",   type: "水",   icon: "assets/icons/moves/润泽.png",   note: "自己获得魔攻+190%", selfBuffStacks: { "魔攻增强": 19 } },
  ...
  { id: "水泡盾",     name: "水泡盾",     power: 0, cost: 2,   category: "defense",  type: "水",   icon: "assets/icons/moves/水泡盾.png", note: "减伤80%，应对攻击：自己获得魔攻+70%", selfBuffStacks: { "魔攻增强": 7 } },
  { id: "水刃",       name: "水刃",       power: 115, cost: 4, category: "physical", type: "水",   icon: "assets/icons/moves/水刃.png",  note: "应对状态：能耗永久-3" },
  ...
  { id: "涌泉",       name: "涌泉",       power: 90, cost: 6,  category: "special",  type: "水",   icon: "assets/icons/moves/涌泉.png",   note: "本技能能耗每-1，威力+10" },
  ...
  { id: "氧输送",     name: "氧输送",     power: 0, cost: 2,   category: "status",   type: "草",   icon: "assets/icons/moves/氧输送.png", note: "自己回复4能量，并获得魔攻+70%", selfBuffStacks: { "魔攻增强": 7 } },
  ...
  { id: "纤维化",     name: "纤维化",     power: 0, cost: 2,   category: "defense",  type: "草",   icon: "assets/icons/moves/纤维化.png",  note: "减伤80%，应对攻击：自己获得物防+70%", selfBuffStacks: { "物防增强": 7 } },
  ...
  { id: "汲取",       name: "汲取",       power: 30, cost: 1,  category: "special",  type: "草",   icon: "assets/icons/moves/汲取.png",   note: "并吸血100%" },
  { id: "飞叶",       name: "飞叶",       power: 40, cost: 0,  category: "physical", type: "草",   icon: "assets/icons/moves/飞叶.png" },
  { id: "孢子爆散",   name: "孢子爆散",   power: 30, cost: 3,  category: "physical", type: "草",   icon: "assets/icons/moves/孢子爆散.png", note: "1连击，每次使用后本技能连击数永久+2" },
  { id: "富养化",     name: "富养化",     power: 0, cost: 3,   category: "status",   type: "草",   icon: "assets/icons/moves/富养化.png",   note: "为场下每个精灵回复3能量" },
  { id: "芳香诱引",   name: "芳香诱引",   power: 0, cost: 2,   category: "status",   type: "草",   icon: "assets/icons/moves/芳香诱引.png", note: "自己获得连击数+2，应对防御：额外造成打断，且敌方下回合获得眩晕" },
  { id: "盛开",       name: "盛开",       power: 0, cost: 1,   category: "status",   type: "草",   icon: "assets/icons/moves/盛开.png",   note: "自己获得全技能威力+30，应对防御：改为威力+60" },
  { id: "聚盐",       name: "聚盐",       power: 0, cost: 3,   category: "status",   type: "草",   icon: "assets/icons/moves/聚盐.png",   note: "2连击，每次连击自己回复8%生命，使用后本技能连击数永久+1，不再恢复能量" },
  ...
  { id: "丰饶",       name: "丰饶",       power: 0, cost: 3,   category: "status",   type: "草",   icon: "assets/icons/moves/丰饶.png",   note: "自己获得物攻和魔攻+140%", selfBuffStacks: { "物攻增强": 14, "魔攻增强": 14 } },
  ...
  { id: "花炮",       name: "花炮",       power: 0, cost: 2,   category: "status",   type: "草",   icon: "assets/icons/moves/花炮.png",   note: "2连击，每次连击自己获得魔攻+60%" },
  // 电
  ...
  { id: "感电",       name: "感电",       power: 60, cost: 2,  category: "special",  type: "电",   icon: "assets/icons/moves/感电.png",   note: "每离场1次，本技能使用次数永久+1" },
  { id: "落雷",       name: "落雷",       power: 35, cost: 3,  category: "special",  type: "电",   icon: "assets/icons/moves/落雷.png",   note: "每次入场，本技能威力永久+40" },
  { id: "电离爆破",   name: "电离爆破",   power: 0, cost: 3,   category: "status",   type: "电",   icon: "assets/icons/moves/电离爆破.png", note: "敌方获得速度-40，3连击" },
  { id: "双联脉冲",   name: "双联脉冲",   power: 50, cost: 4,  category: "special",  type: "电",   icon: "assets/icons/moves/双联脉冲.png", note: "迸发：本技能使用次数+1" },
  ...
  { id: "冰天雪地",   name: "冰天雪地",   power: 0, cost: 2,   category: "defense",  type: "冰",   icon: "assets/icons/moves/冰天雪地.png", note: "减伤80%，应对攻击：被应对技能能耗+3" },
  ...
  { id: "雪球",       name: "雪球",       power: 0, cost: 1,   category: "status",   type: "冰",   icon: "assets/icons/moves/雪球.png",   note: "敌方获得速度-90" },
  ...
  { id: "泥浆铠甲",   name: "泥浆铠甲",   power: 0, cost: 2,   category: "status",   type: "地",   icon: "assets/icons/moves/泥浆铠甲.png", note: "自己获得物攻和物防+60%，应对防御：额外使自己的增益翻倍", selfBuffStacks: { "物攻增强": 6, "物防增强": 6 } },
  ...
  { id: "钧势",       name: "钧势",       power: 0, cost: 3,   category: "status",   type: "地",   icon: "assets/icons/moves/钧势.png",   note: "自己获得物防+140%和速度-30", selfBuffStacks: { "物防增强": 14, "速度增强": -3 } },
  { id: "陨石",       name: "陨石",       power: 100, cost: 3, category: "special",  type: "地",   icon: "assets/icons/moves/陨石.png" },
  { id: "鸣沙陷阱",   name: "鸣沙陷阱",   power: 60, cost: 4,  category: "physical", type: "地",   icon: "assets/icons/moves/鸣沙陷阱.png", note: "物防比敌方越高，本次技能威力越高，物防高于对手271及以上时威力提升至200" },
  { id: "砂石冲撞",   name: "砂石冲撞",   power: 80, cost: 3,  category: "physical", type: "地",   icon: "assets/icons/moves/砂石冲撞.png", note: "若敌方本回合更换精灵，自己获得物防+100%" },
  { id: "地刺",       name: "地刺",       power: 90, cost: 3,  category: "physical", type: "地",   icon: "assets/icons/moves/地刺.png",   note: "应对状态：额外打断被应对技能" },
  ...
  { id: "石肤术",     name: "石肤术",     power: 0, cost: 3,   category: "status",   type: "地",   icon: "assets/icons/moves/石肤术.png", note: "自己获得物防+160%和魔防-60%", selfBuffStacks: { "物防增强": 16, "魔防增强": -6 } },
  { id: "落石",       name: "落石",       power: 55, cost: 1,  category: "physical", type: "地",   icon: "assets/icons/moves/落石.png" },
  { id: "石锁",       name: "石锁",       power: 50, cost: 3,  category: "physical", type: "地",   icon: "assets/icons/moves/石锁.png",   note: "敌方3回合无法更换精灵" },
  { id: "刺盾",       name: "刺盾",       power: 0, cost: 2,   category: "defense",  type: "地",   icon: "assets/icons/moves/刺盾.png",   note: "减伤70%，应对攻击：敌方获得物攻-70%" },
  { id: "不动如山",   name: "不动如山",   power: 0, cost: 2,   category: "defense",  type: "地",   icon: "assets/icons/moves/不动如山.png", note: "应对攻击：自身物攻+50%", selfBuffStacks: { "物攻增强": 5 } },
  { id: "岩脉崩毁",   name: "岩脉崩毁",   power: 120, cost: 4, category: "physical", type: "地",   icon: "assets/icons/moves/岩脉崩毁.png", note: "本技能能耗固定为4" },
  { id: "壁垒",       name: "壁垒",       power: 0, cost: 2,   category: "defense",  type: "地",   icon: "assets/icons/moves/壁垒.png",   note: "减伤90%，应对攻击：防御技能冷却-1" },
  ...
  { id: "龙吟",       name: "龙吟",       power: 0, cost: 3,   category: "status",   type: "龙",   icon: "assets/icons/moves/龙吟.png",   note: "蓄力，自己获得双攻+150%和速度+80", selfBuffStacks: { "物攻增强": 15, "魔攻增强": 15, "速度增强": 8 } },
  ...
  { id: "截拳",       name: "截拳",       power: 85, cost: 3,  category: "physical", type: "武",   icon: "assets/icons/moves/截拳.png",   note: "应对状态：额外造成打断，回复该技能能耗的能量" },
  { id: "气沉丹田",   name: "气沉丹田",   power: 0, cost: 10,  category: "status",   type: "武",   icon: "assets/icons/moves/气沉丹田.png", note: "自己回复60%生命，获得物攻+130%，每次应对后本技能能耗-3，使用后能耗重置", selfBuffStacks: { "物攻增强": 13 } },
  ...
  { id: "斩断",       name: "斩断",       power: 70, cost: 2,  category: "physical", type: "武",   icon: "assets/icons/moves/斩断.png",   note: "应对状态：额外打断被应对技能" },
  { id: "技巧打击",   name: "技巧打击",   power: 35, cost: 2,  category: "physical", type: "武",   icon: "assets/icons/moves/技巧打击.png", note: "应对状态：本次技能威力变为10倍" },
  ...
  { id: "破防",       name: "破防",       power: 0, cost: 2,   category: "status",   type: "武",   icon: "assets/icons/moves/破防.png",   note: "敌方获得双防-70%，应对防御：额外使被应对技能冷却2回合" },
  { id: "预备势",     name: "预备势",     power: 0, cost: 1,   category: "status",   type: "武",   icon: "assets/icons/moves/预备势.png",  note: "自己获得物攻+80%，应对防御：额外使敌方获得物防-80%", selfBuffStacks: { "物攻增强": 8 } },
  ...
  { id: "羽翼庇护",   name: "羽翼庇护",   power: 0, cost: 2,   category: "defense",  type: "翼",   icon: "assets/icons/moves/羽翼庇护.png", note: "减伤70%，应对攻击：自己获得连击数+2" },
  ...
  { id: "羽化加速",   name: "羽化加速",   power: 0, cost: 2,   category: "status",   type: "翼",   icon: "assets/icons/moves/羽化加速.png", note: "自己获得全技能威力+20，迅捷", selfBuffStacks: { "威力增强": 2 } },
  ...
  { id: "闪击",       name: "闪击",       power: 60, cost: 4,  category: "physical", type: "翼",   icon: "assets/icons/moves/闪击.png",  note: "速度比敌方越高威力越高，速度高于对手271及以上时威力提升至200" },
  { id: "乘风",       name: "乘风",       power: 0, cost: 2,   category: "status",   type: "翼",   icon: "assets/icons/moves/乘风.png",   note: "自己获得速度+120", selfBuffStacks: { "速度增强": 12 } },
  ...
  { id: "甜心续航",   name: "甜心续航",   power: 0, cost: 3,   category: "status",   type: "萌",   icon: "assets/icons/moves/甜心续航.png", note: "自己和敌方获得萌化：回复40%生命" },
  ...
  { id: "示弱",       name: "示弱",       power: 0, cost: 1,   category: "status",   type: "萌",   icon: "assets/icons/moves/示弱.png",   note: "自己获得萌化：速度永久+150", selfBuffStacks: { "速度增强": 15 } },
  ...
  { id: "虚化",       name: "虚化",       power: 0, cost: 2,   category: "defense",  type: "幽",   icon: "assets/icons/moves/虚化.png",   note: "减伤80%，应对攻击：自己获得魔防+70%", selfBuffStacks: { "魔防增强": 7 } },
  ...
  { id: "嘲弄",       name: "嘲弄",       power: 0, cost: 2,   category: "status",   type: "幽",   icon: "assets/icons/moves/嘲弄.png",   note: "自己获得魔攻+90%，若敌方本回合更换精灵，自己获得速度+70", selfBuffStacks: { "魔攻增强": 9 } },
  ...
  { id: "贮藏",       name: "贮藏",       power: 0, cost: 2,   category: "status",   type: "虫",   icon: "assets/icons/moves/贮藏.png",   note: "自己获得双攻+50%，每携带1个0能耗技能，额外+50%", selfBuffStacks: { "物攻增强": 5, "魔攻增强": 5 } },
  ...
  { id: "啃咬",       name: "啃咬",       power: 40, cost: 0,  category: "physical", type: "虫",   icon: "assets/icons/moves/啃咬.png",   note: "1连击，本技能会受奉献影响，每被影响1次，能耗永久+1" },
  { id: "虫结阵",     name: "虫结阵",     power: 0, cost: 2,   category: "defense",  type: "虫",   icon: "assets/icons/moves/虫结阵.png", note: "减伤80%，应对攻击：己方队伍获得1次随机奉献" },
  { id: "网缚",       name: "网缚",       power: 60, cost: 2,  category: "physical", type: "虫",   icon: "assets/icons/moves/网缚.png",   note: "敌方获得物防-30%" },
  ...
  { id: "虫网",       name: "虫网",       power: 30, cost: 0,  category: "special",  type: "虫",   icon: "assets/icons/moves/虫网.png",   note: "自己回复1能量" },
  { id: "草虫冲击",   name: "草虫冲击",   power: 80, cost: 3,  category: "physical", type: "虫",   icon: "assets/icons/moves/草虫冲击.png", note: "若敌方本回合更换精灵，本次威力+50且无视敌方系别抵抗" },
  { id: "虫群过境",   name: "虫群过境",   power: 30, cost: 3,  category: "physical", type: "虫",   icon: "assets/icons/moves/虫群过境.png", note: "2连击，己方队伍获得1次奉献：获得连击数+1" },
  { id: "虫群",       name: "虫群",       power: 20, cost: 7,  category: "physical", type: "虫",   icon: "assets/icons/moves/虫群.png",   note: "1连击，本技能会受奉献影响" },
  { id: "翅刃",       name: "翅刃",       power: 95, cost: 4,  category: "physical", type: "虫",   icon: "assets/icons/moves/翅刃.png",   note: "驱散敌方所有印记，应对状态：改为偷取印记" },
  // 机械
  ...
  { id: "啮合传递",   name: "啮合传递",   power: 0, cost: 1,   category: "status",   type: "机械", icon: "assets/icons/moves/啮合传递.png", note: "自己获得速度+30，本技能位于1号或3号位时额外获得物攻+80%，传动1", selfBuffStacks: { "物攻增强": 8, "速度增强": 3 } },
  ...
  { id: "感染病",     name: "感染病",     power: 110, cost: 4, category: "special",  type: "毒",   icon: "assets/icons/moves/感染病.png", note: "若击败敌方则将中毒转化为中毒印记" },
