const MOVES = [
  ...
  { id: "当头棒喝",   name: "当头棒喝",   power: 80,  category: "physical", type: "普通", icon: "assets/icons/moves/当头棒喝.png", note: "若敌方本回合更换精灵，本次技能威力+100" },
  { id: "拍击",       name: "拍击",       power: 65,  category: "special",  type: "普通", icon: "assets/icons/moves/拍击.png" },
  { id: "吞噬",       name: "吞噬",       power: 150, category: "physical", type: "普通", icon: "assets/icons/moves/吞噬.png",   note: "若使用本技能击败敌方，回复6能量" },
  { id: "摇篮曲",     name: "摇篮曲",     power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/摇篮曲.png", note: "敌方获得全技能能耗+3，应对防御：额外造成打断，且敌方下回合获得眩晕" },
  { id: "晒太阳",     name: "晒太阳",     power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/晒太阳.png", note: "驱散敌方所有增益" },
  ...
  { id: "伺机而动",   name: "伺机而动",   power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/伺机而动.png", note: "下一次攻击时，技能威力+70" },
  { id: "后发制人",   name: "后发制人",   power: 155, category: "physical", type: "普通", icon: "assets/icons/moves/后发制人.png", note: "先手-1" },
  { id: "三连破",     name: "三连破",     power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/三连破.png",  note: "自己获得物攻+30%，3连击" },
  { id: "乘胜追击",   name: "乘胜追击",   power: 40,  category: "physical", type: "普通", icon: "assets/icons/moves/乘胜追击.png", note: "每次使用后，连击数永久+1" },
  { id: "快速移动",   name: "快速移动",   power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/快速移动.png", note: "自己获得速度+80，应对防御：改为速度+160" },
  { id: "热身运动",   name: "热身运动",   power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/热身运动.png", note: "自己获得连击数+3" },
  { id: "连续爪击",   name: "连续爪击",   power: 30,  category: "physical", type: "普通", icon: "assets/icons/moves/连续爪击.png", note: "2连击，应对状态：连击数翻倍" },
  { id: "阻断",       name: "阻断",       power: 80,  category: "special",  type: "普通", icon: "assets/icons/moves/阻断.png",   note: "应对状态：打断被应对技能" },
  { id: "加固",       name: "加固",       power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/加固.png",   note: "自己获得物防+140%" },
  { id: "应激反应",   name: "应激反应",   power: 0,   category: "status",   type: "普通", icon: "assets/icons/moves/应激反应.png", note: "自己回复25%生命，应对防御：改为回复50%生命" },
  ...
  { id: "光之矛",     name: "光之矛",     power: 30,  category: "physical", type: "光",   icon: "assets/icons/moves/光之矛.png", note: "3连击" },
  { id: "天光",       name: "天光",       power: 95,  category: "special",  type: "光",   icon: "assets/icons/moves/天光.png",  note: "系别随天气变化" },
  // 火
  { id: "火焰箭",     name: "火焰箭",     power: 80,  category: "physical", type: "火",   icon: "assets/icons/moves/火焰箭.png" },
  { id: "火苗",       name: "火苗",       power: 30,  category: "physical", type: "火",   icon: "assets/icons/moves/火苗.png",   note: "自己回复1能量" },
  { id: "流星火雨",   name: "流星火雨",   power: 75,  category: "physical", type: "火",   icon: "assets/icons/moves/流星火雨.png", note: "每次击败敌方，本技能威力永久+75" },
  { id: "高温回火",   name: "高温回火",   power: 40,  category: "special",  type: "火",   icon: "assets/icons/moves/高温回火.png", note: "自己脱离" },
  { id: "灼伤",       name: "灼伤",       power: 120, category: "physical", type: "火",   icon: "assets/icons/moves/灼伤.png" },
  { id: "火云车",     name: "火云车",     power: 140, category: "physical", type: "火",   icon: "assets/icons/moves/火云车.png" },
  { id: "引燃",       name: "引燃",       power: 0,   category: "status",   type: "火",   icon: "assets/icons/moves/引燃.png",   note: "敌方获得10层灼烧" },
  { id: "焚烧烙印",   name: "焚烧烙印",   power: 0,   category: "status",   type: "火",   icon: "assets/icons/moves/焚烧烙印.png", note: "驱散双方所有印记，每驱散1层，敌方获得5层灼烧" },
  { id: "热身",       name: "热身",       power: 0,   category: "status",   type: "火",   icon: "assets/icons/moves/热身.png",   note: "下一次攻击时，技能威力翻倍，应对防御：改为威力变为4倍" },
  ...
  { id: "炎枪",       name: "炎枪",       power: 100, category: "special",  type: "火",   icon: "assets/icons/moves/炎枪.png" },
  { id: "火焰切割",   name: "火焰切割",   power: 100, category: "physical", type: "火",   icon: "assets/icons/moves/火焰切割.png" },
  { id: "充分燃烧",   name: "充分燃烧",   power: 0,   category: "status",   type: "火",   icon: "assets/icons/moves/充分燃烧.png", note: "使敌方身上的灼烧翻倍，并触发1次灼烧伤害" },
  { id: "易燃物质",   name: "易燃物质",   power: 30,  category: "special",  type: "火",   icon: "assets/icons/moves/易燃物质.png", note: "2连击，每次连击使敌方获得2层灼烧" },
  { id: "爆裂飞弹",   name: "爆裂飞弹",   power: 160, category: "special",  type: "火",   icon: "assets/icons/moves/爆裂飞弹.png" },
  { id: "天火",       name: "天火",       power: 0,   category: "status",   type: "火",   icon: "assets/icons/moves/天火.png",   note: "敌方获得10层灼烧，应对防御：改为获得30层" },
  { id: "除厄",       name: "除厄",       power: 60,  category: "special",  type: "火",   icon: "assets/icons/moves/除厄.png",   note: "驱散自己的减益" },
  // 水
  ...
  { id: "徒长",       name: "徒长",       power: 0,   category: "status",   type: "草",   icon: "assets/icons/moves/徒长.png",   note: "自己回复10能量" },
  // 电
  ...
  { id: "导电撞击",   name: "导电撞击",   power: 40,  category: "physical", type: "电",   icon: "assets/icons/moves/导电撞击.png" },
  { id: "集中",       name: "集中",       power: 0,   category: "defense",  type: "电",   icon: "assets/icons/moves/集中.png",   note: "减伤80%，应对攻击：自己回合结束返场" },
  { id: "过载回路",   name: "过载回路",   power: 0,   category: "status",   type: "电",   icon: "assets/icons/moves/过载回路.png", note: "回合结束自己返场，下回合所选技能使用次数+1" },
  { id: "麻痹",       name: "麻痹",       power: 0,   category: "status",   type: "电",   icon: "assets/icons/moves/麻痹.png",   note: "敌方先手-1，应对防御：额外使敌方获得双攻-70%" },
  ...
  { id: "霜降",       name: "霜降",       power: 0,   category: "status",   type: "冰",   icon: "assets/icons/moves/霜降.png",   note: "敌方获得4层冻结" },
  { id: "暴风雪",     name: "暴风雪",     power: 85,  category: "physical", type: "冰",   icon: "assets/icons/moves/暴风雪.png", note: "敌方获得1层冻结" },
  { id: "冬至",       name: "冬至",       power: 0,   category: "status",   type: "冰",   icon: "assets/icons/moves/冬至.png",   note: "将天气改为暴风雪，持续8回合" },
  { id: "打雪仗",     name: "打雪仗",     power: 45,  category: "special",  type: "冰",   icon: "assets/icons/moves/打雪仗.png", note: "2连击" },
  ...
  { id: "泥浆铠甲",   name: "泥浆铠甲",   power: 0,   category: "status",   type: "地",   icon: "assets/icons/moves/泥浆铠甲.png", note: "自己获得物攻和物防+60%，应对防御：额外使自己的增益翻倍" },
  // 幻
  ...
  { id: "超维投射",   name: "超维投射",   power: 0,   category: "status",   type: "幻",   icon: "assets/icons/moves/超维投射.png", note: "敌方获得4层星陨印记" },
  { id: "二律背反",   name: "二律背反",   power: 0,   category: "status",   type: "幻",   icon: "assets/icons/moves/二律背反.png", note: "敌方获得3层星陨印记，应对防御：额外使敌方星陨印记层数翻倍" },
  { id: "双星",       name: "双星",       power: 100, category: "physical", type: "幻",   icon: "assets/icons/moves/双星.png" },
  { id: "多维击打",   name: "多维击打",   power: 15,  category: "special",  type: "幻",   icon: "assets/icons/moves/多维击打.png", note: "1连击，敌方每有1层星陨印记，本次技能连击数+1" },
  { id: "星轨裂变",   name: "星轨裂变",   power: 0,   category: "status",   type: "幻",   icon: "assets/icons/moves/星轨裂变.png", note: "敌方获得2层星陨印记" },
  // 龙
  ...
  { id: "诋毁",       name: "诋毁",       power: 80,  category: "physical", type: "恶",   icon: "assets/icons/moves/诋毁.png" },
  { id: "跌落",       name: "跌落",       power: 120, category: "physical", type: "恶",   icon: "assets/icons/moves/跌落.png",   note: "自己获得物攻-50%，应对状态：改为获得物攻+50%" },
  { id: "贪婪",       name: "贪婪",       power: 0,   category: "status",   type: "恶",   icon: "assets/icons/moves/贪婪.png",   note: "自己获得100%吸血" },
  ...
  { id: "化劲",       name: "化劲",       power: 0,   category: "status",   type: "武",   icon: "assets/icons/moves/化劲.png",   note: "自己获得全技能威力+40" },
  // 翼
  { id: "鹰爪",       name: "鹰爪",       power: 60,  category: "physical", type: "翼",   icon: "assets/icons/moves/鹰爪.png" },
  { id: "风矢",       name: "风矢",       power: 80,  category: "physical", type: "翼",   icon: "assets/icons/moves/风矢.png" },
  ...
  { id: "啄击",       name: "啄击",       power: 15,  category: "physical", type: "翼",   icon: "assets/icons/moves/啄击.png",   note: "2连击" },
  { id: "疾风刺",     name: "疾风刺",     power: 25,  category: "physical", type: "翼",   icon: "assets/icons/moves/疾风刺.png", note: "先于敌方攻击改为3连击" },
  { id: "扇风",       name: "扇风",       power: 75,  category: "physical", type: "翼",   icon: "assets/icons/moves/扇风.png",   note: "先于敌方攻击，威力+50%" },
  { id: "回旋风暴",   name: "回旋风暴",   power: 100, category: "special",  type: "翼",   icon: "assets/icons/moves/回旋风暴.png" },
  { id: "暴风眼",     name: "暴风眼",     power: 0,   category: "status",   type: "翼",   icon: "assets/icons/moves/暴风眼.png", note: "行动时连击数+100%" },
  { id: "羽化加速",   name: "羽化加速",   power: 0,   category: "status",   type: "翼",   icon: "assets/icons/moves/羽化加速.png", note: "自己获得全技能威力+20，迅捷" },
  { id: "翼击",       name: "翼击",       power: 50,  category: "special",  type: "翼",   icon: "assets/icons/moves/翼击.png",  note: "迅捷" },
  { id: "风起",       name: "风起",       power: 0,   category: "status",   type: "翼",   icon: "assets/icons/moves/风起.png",  note: "自己获得1层风起印记" },
  { id: "羽刃",       name: "羽刃",       power: 75,  category: "physical", type: "翼",   icon: "assets/icons/moves/羽刃.png",  note: "应对状态：回合结束使敌方紧急脱离" },
  ...
  { id: "甜心续航",   name: "甜心续航",   power: 0,   category: "status",   type: "萌",   icon: "assets/icons/moves/甜心续航.png", note: "自己和敌方获得萌化：回复40%生命和4能量" },
  // 幽
  ...
  { id: "勾魂",       name: "勾魂",       power: 0,   category: "status",   type: "幽",   icon: "assets/icons/moves/勾魂.png",   note: "偷取敌方3能量" },
  // 虫
  ...
  { id: "假寐",       name: "假寐",       power: 0,   category: "status",   type: "虫",   icon: "assets/icons/moves/假寐.png",   note: "自己回复2能量，己方队伍获得1次奉献：能耗-2" },
  // 机械
  ...
  { id: "啮合传递",   name: "啮合传递",   power: 0,   category: "status",   type: "机械", icon: "assets/icons/moves/啮合传递.png", note: "自己获得速度+80，本技能位于1号或3号位时额外获得物攻+60%，传动1" },
  // 毒
  ...
  { id: "毒孢子",     name: "毒孢子",     power: 0,   category: "status",   type: "毒",   icon: "assets/icons/moves/毒孢子.png", note: "敌方获得5层中毒" },
];
